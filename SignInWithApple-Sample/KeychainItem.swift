...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.Napra.SignInWithApple-Sample", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.Napra.SignInWithApple-Sample", account: "userIdentifier").deleteItem()
        } catch {
